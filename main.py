...
#define paths
path = 'C:/Users/DELL/Downloads/archive.zip/New Plant Diseases Dataset(Augmented)/New Plant Diseases Dataset(Augmented)'
path_train = path+'/train'
path_frame = 'C:/Users/DELL/Downloads/IoT JComp/frame/'

#load model
print('loading model......')
b_model = load_model('C:/Users/DELL/Downloads/IoT JComp/iot model/best_model.h5')
print('model loaded!!')
